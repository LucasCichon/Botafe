...
namespace Botafe.Persistance.Migrations
{
    ...
    [Migration("20240513101949_configuration")]
            ...
            modelBuilder.Entity("Botafe.Domain.Entities.EventOwner", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 5, 13, 12, 19, 48, 562, DateTimeKind.Local).AddTicks(7536),
                            StatusId = 1
                        });
                });
            ...
            modelBuilder.Entity("Botafe.Domain.Entities.Participant", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 5, 13, 12, 19, 48, 562, DateTimeKind.Local).AddTicks(8933),
