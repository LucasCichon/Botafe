...
namespace Botafe.Persistance.Migrations
{
    ...
    [Migration("20240510113331_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Botafe.Domain.ValueObjects.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Botafe.Domain.Entities.Participant", b =>
                {
                    ...
                    b.OwnsOne("Botafe.Domain.Entities.ParticipantAddress", "ParticipantAddress", b1 =>
                        {
                            b1.Property<int>("ParticipantId")
                                .HasColumnType("int");
                            ...
                            b1.Property<DateTime?>("Inactivated")
                                .HasColumnType("datetime2");

                            b1.Property<string>("InactivatedBy")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");
                            ...
                            b1.HasOne("Botafe.Domain.ValueObjects.Address", "Address")
                                .WithMany()
                                .HasForeignKey("AddressId")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();

                            b1.WithOwner("Participant")
                                .HasForeignKey("ParticipantId");
